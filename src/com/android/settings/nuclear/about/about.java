...
private static final String NS_ROM_SHARE = "share";
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mForumUrl) {
            launchUrl("http://forum.xda-developers.com/oneplus-one/development/6-0-nuclearandroidproject-t3247658");
        } else if (preference == mKernelUrl) {
            launchUrl("http://forum.xda-developers.com/oneplus-one/development/radioactive-kernel-aosp-mm-t3247460");
        } else if (preference == mSourceUrl) {
            launchUrl("https://github.com/NuclearAndroidProject1");
        } else if (preference == mDonateUrl) {
            launchUrl("http://paypal.me/TeamNuclear");
        } else if (preference == mSourcebaseUrl) {
            launchUrl("https://github.com/AOSParadox");
